...
;(function ( $, window, document, undefined ) {
    ...
    _.showError = function(errorCode) {
        var self = this ;
    ...
    _.parseVideo = function(file) {
        var self = this ;
        
        var $video = $('<video controls="" preload="auto" autoplay style="width:1px;height:1px;"><source></video>') ;
    ...
    _.parseBase64ByImgUrl = function(imgUrl, callback) {
        var self = this ;
    ...
    _.parseCanvas = function(canvas, callback) {
        var self = this ;
    ...
    _.prepare2Callback = function(result) {
        var self = this ;
